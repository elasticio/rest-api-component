...
7. ``Request timeout`` - Timeout period in milliseconds while component waiting for server response, also can be configured with REQUEST_TIMEOUT envar. Default to 100000 (100 sec).

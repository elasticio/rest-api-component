...
module.exports.processMethod = function (isAction, msg, cfg) {
    ...
    var isNeedRedirect = function (){
        if(cfg.followRedirect==="2"){
            return false;
        }
        return true;        
    };
    ...
    return new Promise((resolve, reject) => {
        request[formattedMethod](requestOptions, function (error, response, body) {
            ...
            try {
                console.log(`Have got headers ${JSON.stringify(response.headers)} and response "${body}"`);

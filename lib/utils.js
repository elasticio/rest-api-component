/* eslint-disable max-len,no-shadow,no-param-reassign,no-underscore-dangle,no-use-before-define,consistent-return,func-names */
  ...
  */
  function processResponse(response) {
    ...
    if (contType) {
      ...
      return Promise.resolve(
        buildResponseStructure({ result: response.body.toString('utf8') }),
      );
    }

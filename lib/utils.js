...
module.exports.processMethod = async function (msg, cfg) {
  ...
  return buildRequestBody()
    ...
    .then(async (result) => {
      ...
      if (cfg.delayBetweenCalls) {
        emitter.logger.info('Delay is start', new Date());
        await sleep(cfg.delayBetweenCalls);
        emitter.logger.info('Delay is done', new Date());
      }
  ...
  */
  ...
  function sleep(delayBetweenCalls) {
